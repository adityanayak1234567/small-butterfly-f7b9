...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/small-butterfly-f7b9)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/small-butterfly-f7b9
```

A live public deployment of this template is available at [https://small-butterfly-f7b9.templates.workers.dev](https://small-butterfly-f7b9.templates.workers.dev)
